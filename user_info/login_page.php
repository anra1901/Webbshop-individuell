...
<form name="loginForm" action="login.php" method="POST" id="login-form" class="form-container">
  ...
  <div class="login_field-password form-container__box">
    ...
    <input type="password" name="password" id="loginPassword" class="form-container__box-input" required>
  </div>
