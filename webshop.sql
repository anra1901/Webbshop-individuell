...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2020 at 10:15 AM
...
--
-- Table structure for table `webshop_categories`
--
...
--
-- Dumping data for table `webshop_categories`
--

INSERT INTO `webshop_categories` (`
categoryid`,
`category
`, `image`) VALUES
...
--
-- Table structure for table `webshop_orderproducts`
--
...
--
-- Table structure for table `webshop_orders`
--
...
--
-- Dumping data for table `webshop_orders`
--
...
`name`,
`email
`, `phone`, `street`, `zip`, `city`, `status`, `products`, `freight`, `totalprice`) VALUES
...
--
-- Table structure for table `webshop_orderscomplete`
--
...
--
-- Dumping data for table `webshop_orderscomplete`
--

INSERT INTO `webshop_orderscomplete` (`
orderid`,
`orderdate`,
`name`,
`email
...
--
-- Table structure for table `webshop_productimages`
--
...
--
-- Table structure for table `webshop_products`
--
...
--
-- Dumping data for table `webshop_products`
--

INSERT INTO `webshop_products` (`
productid`,
`categoryid
`, `title`, `description`, `price`, `quantity`, `productimg`, `date`) VALUES
...
(18, 4, 'Det borde man ju veta', 'Ett spel om allt det där man faktiskt borde veta.. Det borde man ju veta! är ett medryckande och underhållande frågespel med över 400 frågor om sånt man faktiskt borde veta.', '165', 31, 'a:2:{i:0;s:13:\"labyrint2.jpg\";i:1;s:36:\"photo-1567304529193-acc92518efcd.jpg\";}', '2020-03-20 00:00:00'),
...
(61, 2, 'Apelsin', 'dfhdf dfh df', '250', 8, 'a:1:{i:0;s:0:\"\";}', '2020-05-11 12:41:44');

-- --------------------------------------------------------

--
-- Table structure for table `webshop_users`
--
...
--
-- Dumping data for table `webshop_users`
--

INSERT INTO `webshop_users` (`
userid`,
`name
`, `password`, `email`, `street`, `zipcode`, `city`, `telephone`) VALUES
(16, 'Ana', '$2y$10$dB1jYv9p/MKesDGkVB6d3OezgKyi.1E3nS0FCQx3.LWaKeG12fY4G', 'ana@test.se', 'asdasd', '12321', 'adsaad', 12313),
(17, 'Chris', '$2y$10$Z.kLk09CZFwd2EmwaVlvoO4U8zfRcT3o7F6j4Ity05mKzyEmkAHgC', 'chris@test.se', 'HejHej 2', '12315', 'Växjö', 702222222);
...
--
-- Indexes for table `webshop_categories`
--
...
--
-- Indexes for table `webshop_orderproducts`
--
...
--
-- Indexes for table `webshop_orders`
--
...
--
-- Indexes for table `webshop_orderscomplete`
--
...
--
-- Indexes for table `webshop_productimages`
--
ALTER TABLE `webshop_productimages`
ADD PRIMARY KEY
(`imageid`),
ADD KEY `Referensintegritet`
(`productid`) USING BTREE;

--
-- Indexes for table `webshop_products`
--
...
--
-- Indexes for table `webshop_users`
--
ALTER TABLE `webshop_users`
ADD PRIMARY KEY
(`userid`);
...
--
-- AUTO_INCREMENT for table `webshop_categories`
--
ALTER TABLE `webshop_categories`
...
--
-- AUTO_INCREMENT for table `webshop_orderproducts`
--
ALTER TABLE `webshop_orderproducts`
  MODIFY `orderproductid` int
(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `webshop_orders`
--
ALTER TABLE `webshop_orders`
  MODIFY `orderid` int
...
--
-- AUTO_INCREMENT for table `webshop_productimages`
--
ALTER TABLE `webshop_productimages`
  MODIFY `imageid` int
(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `webshop_products`
--
ALTER TABLE `webshop_products`
  MODIFY `productid` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `webshop_users`
--
ALTER TABLE `webshop_users`
  MODIFY `userid` int
...
--
-- Constraints for table `webshop_orderproducts`
--
ALTER TABLE `webshop_orderproducts`
ADD CONSTRAINT `webshop_orderproducts_ibfk_1` FOREIGN KEY
(`productid`) REFERENCES `webshop_products`
(`productid`),
ADD CONSTRAINT `webshop_orderproducts_ibfk_2` FOREIGN KEY
(`orderid`) REFERENCES `webshop_orders`
(`orderid`);

--
-- Constraints for table `webshop_productimages`
--
ALTER TABLE `webshop_productimages`
ADD CONSTRAINT `webshop_productimages_ibfk_1` FOREIGN KEY
(`productid`) REFERENCES `webshop_products`
(`productid`);

--
-- Constraints for table `webshop_products`
--
ALTER TABLE `webshop_products`
ADD CONSTRAINT `Referensintegritet` FOREIGN KEY
(`categoryid`) REFERENCES `webshop_categories`
(`categoryid`);
COMMIT;
